...
Otro uso habitual del modelo raster es en los denominados \textbf{Modelos Digitales de Elevaciones} (MDE), que recogen la topografía de un terreno. 

De forma general, los valores de una capa ráster, en cualquiera de sus bandas, son \textbf{casi exclusivamente numéricos}, no estando los SIG preparados para manejar otro tipo de valores en la componente temática de una capa ráster. De esta forma, una capa raster puede equipararse al concepto matemático de una \textbf{matriz}, con las ventajas que ello supone para aplicar sobre ella herramientas matemáticas a la hora de su análisis.
