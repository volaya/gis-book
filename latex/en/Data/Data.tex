...
Entendemos como dato al simple \textbf{conjunto de valores o elementos que utilizamos para representar algo}. Por ejemplo, el código 502132N es un dato. 
...
\begin{figure}[!hbt] 
\centering
\includegraphics[width=\textwidth]{../es/Datos/Dimensiones.pdf}
...
\section{Modelos para la información geográfica}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.4\textwidth]{../es/Datos/Raster_closeup.png}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=\textwidth]{../es/Datos/Primitivas_vectoriales.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.8\columnwidth]{../es/Datos/Topologia_vias.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=\textwidth]{../es/Datos/Esquemas_modelos_representacion.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.4\columnwidth]{../es/Datos/Imprecision_raster.png}
