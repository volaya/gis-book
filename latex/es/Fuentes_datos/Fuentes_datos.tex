...
Los sensores se denominan \textbf{pasivos} si aprovechan las fuentes de radiación existentes en la naturaleza (fundamentalmente el Sol) y se limitan a recoger la radiación de dichas fuentes reflejada por los elementos del medio, o \textbf{activos} si emiten radiación, y recogen dicha radiación tras ser reflejada por dichos elementos. Para entender este concepto de un modo de un modo sencillo, podemos decir que una cámara fotográfica es un sensor pasivo, mientras que una camara fotográfica con \emph{flash} es un sensor activo. La radiación emitida por los sensores activos no ha de ser necesariamente luz visible (como en el caso del flash), sino que pueden emitir en otras secciones del espectro.
...
Trabajando en el entorno de un SIG, los metadatos se asocian a una capa y a su contenido, y pueden \textbf{referirse a ambas componentes} (temática y espacial)
