...
La visualización de datos geográficos en un SIG se compone fundamentalmente de un \textbf{lienzo} sobre el que se sitúan las distintas capas, y que el usuario va conformando añadiendo nuevas capas y editando su \textbf{simbología}, es decir, la forma en la que estas se representan. Las capas se sitúan en un \textbf{orden dado} dentro del lienzo, lo que permite establecer una \textbf{jerarquía de representación} y así lograr el aspecto deseado.
...
\begin{itemize}
	\item \textbf{Disponibilidad}. Los estándares abiertos están disponibles para todo el mundo para su lectura y uso en cualquier implementación.
