...
La percepción de las variables \textbf{puede verse alterada por el medio}. Es importante estudiar esta alteración desde dos puntos de vista: la \textbf{constancia perceptiva} (hasta qué punto podemos modificar los elementos visuales o su entorno sin que dejen de transmitir su información y se confundan sus características) y las \textbf{ayudas a la percepción} (cómo podemos facilitar que se perciban exactamente como pretendemos)
