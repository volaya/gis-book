...
tableshtml={
"Table:PropertiesVisualVariables": r'<table border="1"><col width="11%" /><col width="13%" /><col width="13%" /><col width="13%" /><col width="13%" /><col width="13%" /><col width="13%" /><col width="13%" /></colgroup><thead valign="bottom"><tr class="row-odd"><th class="head">Property</th><th class="head">Position</th><th class="head">Size</th><th class="head">Shape</th><th class="head">Value</th><th class="head">Hue</th><th class="head">Texture</th><th class="head">Orientation</th></tr></thead><tbody valign="top"><tr class="row-even"><td>Associative</td><td>&loz;</td><td>&#8212;</td><td>&loz;</td><td>&#8212;</td><td>&loz;</td><td>&loz;</td><td>&loz;</td></tr><tr class="row-odd"><td>Selective</td><td>&loz;</td><td>&loz;</td><td>&#8212;</td><td>&loz;</td><td>&loz;</td><td>&loz;</td><td>&loz;</td></tr><tr class="row-even"><td>Ordered</td><td>&loz;</td><td>&loz;</td><td>&#8212;</td><td>&loz;</td><td>&#8212;</td><td>&#8212;</td><td>&#8212;</td></tr><tr class="row-odd"><td>Quantitative</td><td>&loz;</td><td>&loz;</td><td>&#8212;</td><td>&#8212;</td><td>&#8212;</td><td>&#8212;</td><td>&#8212;</td></tr></tbody></table>'
}
...
exps_pre = [(r"\\bigskip", ""),
        ...
        (r"\\small", ""),
        (r"\\emph\{(.*?)\}", r"<i>\1</i>"),
        (r"``Sistemas de Informaci\\'{o}n Geogr\\'{a}fica''", "<i>Sistemas de Información Geográfica</i>"),
        (r"``Introducci\\'{o}n a los SIG''", "<i>Introducción a los SIG</i>"),
        (r"\$(.*?)\$", r"<i>\1</i>")]
